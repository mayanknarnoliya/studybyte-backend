...
// SAFE CODE: Check karo ki doosri categories hain ya nahi
    let differentCategories = null;
    if (categoriesExceptSelected.length > 0) {
        let randomIndex = getRandomInt(categoriesExceptSelected.length);
    ...
    .sort((a, b) => {
        const aLen = a.studentsEnrolled?.length || 0;
        const bLen = b.studentsEnrolled?.length || 0;
        return bLen - aLen;
    })
    .slice(0, 10);
