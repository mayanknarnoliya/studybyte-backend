...
exports.contactUs = async (req, res) => {
    try {
        ...
        // send mail (user message) from user to StudyByte
        try {
            await mailSender(
            ...
            console.log('Error while sending mail from user to StudyByte');
            console.log(err);
        ...
        // send mail from StudyByte to user (your message has been delievered)
        try {
